<h2><a href="https://www.geeksforgeeks.org/problems/print-the-pattern-set-1/1?page=1&category=pattern-printing&sortBy=difficulty">Print Number Pattern</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p>You are given a number <code>n</code>. You need to generate and print a pattern based on the given value of <code>n</code>.</p>
<ol>
